---
title: "Kubernetes教程(二)---集群网络之 Flannel 核心原理"
...
> Docker 单机容器网络具体实现可以参考： [Docker教程(四)---容器网络实现分析](https://www.lixueduan.com/posts/docker/04-container-network/) 以及 [Docker教程(十)---Docker 单机(桥接)网络实现](https://www.lixueduan.com/posts/docker/10-bridge-network/) 这两篇文章。



为了解决这个容器**跨主通信**的问题，k8s 制定了 CNI 规范，然后社区里依据该规范出现了各种各样的容器网络方案。其中 Flannel 是最早实现的，也是最简单的一个，因此我们使用 Flannel 来分析。
...
[flannel-docs-backends.md](https://github.com/flannel-io/flannel/blob/f30ebbb670dcbfa7ff5f0d1dd9cccacd2d660a41/Documentation/backends.md)
...
[flannel-udp]:../../../img/kubernetes/network/flannel/flannel-udp.jpg
[flannel-udp-tun]:../../../img/kubernetes/network/flannel/flannel-udp-tun.jpg
[flannel-vxlan]:../../../img/kubernetes/network/flannel/flannel-vxlan.jpg

[flannel-vxlan-inner-data-frame]:../../../img/kubernetes/network/flannel/flannel-vxlan-inner-data-frame.jpg

[flannel-vxlan-outer-data-frame]:../../../img/kubernetes/network/flannel/flannel-vxlan-outer-data-frame.jpg
